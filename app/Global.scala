...
package object globals {
  ...
  val country_appearance0 = Play.current.configuration.getString("country.country_appearance0").getOrElse("Not Set")
  ...
  val country_appearance6 = Play.current.configuration.getString("country.country_appearance6").getOrElse("Not Set")
